...
// alert(
//   `Yo man have you seen the new ${car.carName} car, bro its called the ${car.carModel} model comes with a crazy ${car.carHorsePower} monster horse power, the guy next block got one its dope ${car.carColor} color. ${car.carDescription()}`
// );
